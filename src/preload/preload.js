...
contextBridge.exposeInMainWorld('ordena', {
  ...
  cachedScan: (root) => invoke('scan:cached', root),
  cachedScans: () => invoke('scan:cachedList'),
  forgetCached: (root) => invoke('scan:forgetCached', root),
  ...
  ops: {
    ...
    revealQuarantine: (id) => invoke('ops:revealQuarantine', id),
  },
  shell: {
